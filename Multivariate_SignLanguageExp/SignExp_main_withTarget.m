...
GlobalRunNumberID=input('Run Number(01-12): ', 's');
...
output_file_name_tab= strcat(output_directory,'/sub-', GlobalGroupID,GlobalSubjectID, '_task-', GlobalExpID,'_run-',GlobalRunNumberID,'_events','.tsv');
